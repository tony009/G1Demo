...
- (void)viewWillAppear:(BOOL)animated{
    ...
    NSLog(@"viewWillAppear:width:%f,height:%f,x:%f,y:%f",self.kView.frame.size.width,self.kView.frame.size.height,self.kView.frame.origin.x,self.kView.frame.origin.y);
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    self.kcalculatorView.delegate = self;
    //self.kView.backgroundColor = [UIColor redColor];
}
